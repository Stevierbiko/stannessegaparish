      ...
      <div className="container value__container">
        ...
        <div className="value__right">
          ...
          <p>
            ...
            challenges of modern society. Modern Catholic social teaching has
            been articulated through a tradition of papal, conciliar, and
            episcopal documents. The depth and richness of this tradition can be
            understood best through a direct reading of these documents. In
            these brief reflections, we highlight several of the key themes that
